      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          ...
          <div>
            ...
            {/* Map Placeholder */}
            <div className="mt-8 h-64 bg-gradient-to-br from-primary/20 to-studio-orange/20 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <MapPin className="w-12 h-12 text-primary mx-auto mb-2" />
                <p className="text-studio-navy font-semibold">Gahanga, Kigali, Rwanda</p>
